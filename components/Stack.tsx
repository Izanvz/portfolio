...
const groups: StackGroup[] = [
  ...
  },
  {
    ...
    secondaryItems: ["Pandas", "SQL"],
    core: false,
  },
  {
    title: "Machine Learning & AI",
    symbol: "∇",
    desc: "Orquestación de agentes, modelos de audio y NLP aplicado.",
    primaryItems: ["LangGraph", "WhisperX", "Ollama", "Mistral 7B", "Whisper", "PyTorch"],
    secondaryItems: ["XGBoost", "Scikit-learn", "YOLOv8", "PaddleOCR"],
    core: true,
  },
  {
    title: "DevOps & Herramientas",
    symbol: "▶",
    desc: "Entornos reproducibles, ejecución local y despliegue.",
    primaryItems: ["Docker", "Docker Compose"],
    secondaryItems: ["GPU local (CUDA)", "Gestión de entornos", "Config por parámetros"],
    core: false,
  },
];
